...
const cssFragments = [
  ...
  "body.theme-inkblue :is(#inventoryPage, #craftPage) :is(#listWrap, .menu-list, .task-queue-list, .drawer-select-list, .craft-selection-list, .craft-queue-list, .craft-assist-picker, .craft-assist-list, .craft-assist-preset-list) {",
  "scrollbar-color: rgba(220, 164, 76, 0.72) rgba(12, 14, 18, 0.88);",
  "body.theme-inkblue :is(#inventoryPage, #craftPage) :is(#listWrap, .menu-list, .task-queue-list, .drawer-select-list, .craft-selection-list, .craft-queue-list, .craft-assist-picker, .craft-assist-list, .craft-assist-preset-list)::-webkit-scrollbar {",
  "body.theme-inkblue :is(#inventoryPage, #craftPage) :is(#listWrap, .menu-list, .task-queue-list, .drawer-select-list, .craft-selection-list, .craft-queue-list, .craft-assist-picker, .craft-assist-list, .craft-assist-preset-list)::-webkit-scrollbar-thumb {",
